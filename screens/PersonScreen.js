    ...
    >
      ...
      <View className="w-full">
        <View
          ...
          className={ios ? topMargin : "w-full flex-row justify-between items-center px-4"}
        >
          <TouchableOpacity
            onPress={() => navigation.goBack()}
            style={[styles.background, { paddingHorizontal: 10 }]}
            className="rounded-xl p-1"
          >
            <ChevronLeftIcon size="28" strokeWidth={2.5} color="white" />
          </TouchableOpacity>
          <TouchableOpacity onPress={()=> toggleFavourite(!isFavourite)}>
            <HeartIcon style={{marginTop: 0}} size="35" color={isFavourite? 'red' : "white"}/>
          </TouchableOpacity>
        </View>
      </View>
